...
<template>
  <div class="relative chat-input-model">
    ...
    <div
      ...
      ref="popupRef"
      class="absolute top-full mb-2 mt-2 left-0 bg-(--bg-color) border border-(--sub-color) rounded-lg shadow-lg w-60 max-h-60 z-20 chat-input-model-popup overflow-y-auto"
    >
      <div
        v-for="page in pages"
        :key="page.name"
